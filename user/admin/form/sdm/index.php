<div class="box-header with-border">
  ...
  <div class="box-tools pull-right">
    ...
    <a href="#" class="btn btn-info btn-sm"  data-toggle="modal" data-target="#addballroom">Tambah SDM</a>
  </div>
</div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah SDM</h4>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Simpan Data SDM</button>
