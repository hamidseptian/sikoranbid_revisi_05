              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" class="form-control" required name="status" value="0">
                    <input type="hidden" class="form-control" required name="menu" value="<?php echo $menu ?>">
                    <input type="hidden" class="form-control" required name="bidang_pengusul" value="<?php echo $bidang_pengusul ?>">
