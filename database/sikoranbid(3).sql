...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2021 at 02:41 AM
...
(25, 9, 'MC', '-', 2, '3'),
(26, 9, 'Honor panitia', 'OK', 2, '3'),
(27, 9, 'Ruangan', '-', 1, '1'),
(28, 9, 'Snack', '-', 20, '1'),
(29, 9, 'Sound System', '-', 1, '1'),
(30, 9, 'Camera', '-', 1, '1'),
(31, 9, 'Honor Pemateri', '', 2, '1'),
...
(4, '2', '17', 6, '2021-06-10', '', '0'),
(5, '2', '17', 3, '2021-06-10', '', '0');
...
(67, '41', '1', 'tamnu', '', '', '', '1', '0', ''),
(68, '42', '6', 'mohon segera di penuhi', '7', '', '', '1', '0', 'fsdf'),
...
INSERT INTO `pengumpulan` (`id_pengumpulan`, `jenis`, `keterangan`, `jumlah`, `file`, `status`, `tgl_infaq`, `jam_infaq`, `id_muzaki`, `catatan`) VALUES
...
(16, 'Infaq / Sedekah', 'Donasi dari Muzaki \r\nAndika ', '40000', '210604083704Capture.PNG', '0', '2021-06-04', '08:36', '4', ''),
...
(22, 'Infaq / Sedekah', 'Donasi dari Muzaki \r\nUdin penyok ', '50000000', '210711092833kwitasni.jpg', '0', '2021-07-11', '09:28', '7', '');
...
(10, '2', 'Diusulkan', 'Gerai Zakat', 'gerai zakat', '6', '', '2021-07-09', '22:37', '210709103725STRUKTUR ORGANISASI SMPN 4 BATANG ANAI.pdf'),
...
--
ALTER TABLE `detail_proker`
  MODIFY `id_detail_proker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `komentar_proker`
  MODIFY `id_komentar_proker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `pendistribusian_proker`
  MODIFY `id_pendistribusian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `pengumpulan`
  MODIFY `id_pengumpulan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `proker`
  MODIFY `id_proker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
